...
int main(int argc, char **argv) {
	...
	string input_file = "original_40.jpg";
	...
	string str = "convert "; 
    str = str + "original_40.jpg " + "original_40.pgm";
    ...
    char *t1 = "original_40.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_40_edge.pgm";
    char *t4 = "d_original_40_edge.pgm";
