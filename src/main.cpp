...
int main(int argc, char **argv) {
	...
	string input_file = "original_50.jpg";
	...
	string str = "convert "; 
    str = str + "original_50.jpg " + "original_50.pgm";
    ...
    char *t1 = "original_50.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_50_edge.pgm";
    char *t4 = "d_original_50_edge.pgm";
