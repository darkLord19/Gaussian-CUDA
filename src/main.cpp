...
int main(int argc, char **argv) {
	...
	string input_file = "original_30.jpg";
	...
	string str = "convert "; 
    str = str + "original_30.jpg " + "original_30.pgm";
    ...
    char *t1 = "original_30.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_30_edge.pgm";
    char *t4 = "d_original_30_edge.pgm";
