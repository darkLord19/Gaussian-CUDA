...
int main(int argc, char **argv) {
	...
	string input_file = "original_80.jpg";
	...
	string str = "convert "; 
    str = str + "original_80.jpg " + "original_80.pgm";
    ...
    char *t1 = "original_80.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_80_edge.pgm";
    char *t4 = "d_original_80_edge.pgm";
