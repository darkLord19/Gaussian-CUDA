...
int main(int argc, char **argv) {
	...
	string input_file = "original_70.jpg";
	...
	string str = "convert "; 
    str = str + "original_70.jpg " + "original_70.pgm";
    ...
    char *t1 = "original_70.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_70_edge.pgm";
    char *t4 = "d_original_70_edge.pgm";
