...
int main(int argc, char **argv) {
	...
	string input_file = "original_60.jpg";
	...
	string str = "convert "; 
    str = str + "original_60.jpg " + "original_60.pgm";
    ...
    char *t1 = "original_60.pgm";
    char *t2 = "d_gauss.pgm";
    char *t3 = "h_original_60_edge.pgm";
    char *t4 = "d_original_60_edge.pgm";
